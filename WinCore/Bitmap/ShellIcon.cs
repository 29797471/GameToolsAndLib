...
public static class ShellIcon
{
    ...
    public static Icon GetIconByBase(string fileName)
    {
    ...
    {
        var icon = FileOpr.IsFolderPath(path) ? GetLargeFolderIcon() : GetLargeIcon(path);
    ...
    public static System.Windows.Controls.Image DrawImage(string path, float size = 0f)
    {
        ...
        if (size != 0f) img.Width = size; img.Height = size;
        return img;
    }
